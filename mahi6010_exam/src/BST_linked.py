...
class BST:
    ...
    def _reverse_aux(self, root, level, k):
        """
        ---------------------------------------------------------
        ...
        ---------------------------------------------------------
        Parameters:
            k - level that needs to be changed
        Returns‌‌​‌​​‌‌:
            # your code here
        ---------------------------------------------------------
        """
        ...
        self._reverse_aux(root, 1, k)
        self._reverse_aux(root.left, level + 1, k)
        self._reverse_aux(root.right, level + 1, k)
        return

    def _shift_left(self, root):
        """
        -------------------------------------------------------
